...
(function () {
  ...
  // Mientras espera datos: avanza despacio hasta ~88%
  var IDLE_FILL_MS = 2800;
  var IDLE_FILL_CAP = 0.88;
  // Al terminar: completa lo que falte rápido (mín. 180ms, máx. 420ms)
  var COMPLETE_MIN_MS = 180;
  var COMPLETE_MAX_MS = 420;
  ...
  function setFill(value) {
    ...
    var el = document.getElementById("ml-preload");
  ...
  function tickIdleFill(now) {
    ...
    setFill(IDLE_FILL_CAP * easeOutCubic(t));
  ...
  function completeFill(onComplete) {
    ...
    // Si ya estaba casi lleno / carga rápida: cierra en poco tiempo.
    // Si apenas empezó: también rápido, pero un poquito más para que se vea el movimiento.
