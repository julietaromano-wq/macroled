...
/* =========================================================
   ASISTENTE — autocontenido en comparar (sin CDNs extra)
   ========================================================= */
(function () {
  "use strict";
  ...
  function init(options) {
    ...
    const fallbackHtml = typeof options.fallbackHtml === "function"
      ? options.fallbackHtml
      : () => "No pude encontrar información sobre esa consulta en este momento.";
